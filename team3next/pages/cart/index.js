...
export default function CartDetail() {
  ...
  const addWish = (product_id) => {
    ...
    const productt = dataCart.find((i) => {
      return i.product_id === product_id;
    });
    fetch("http://localhost:3002/api/cart/wishList", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        pid: productt.product_id,
            ...
            <thead>
              ...
              <tr>
                <th scope="col" className={styles.cartNum + " border-0"}>
                  {`購物車(` + calculateTotal().productTotal + `)`}
                </th>
              </tr>
                  ...
                  {delivery == "7-11超商取貨" ? (
                    <>
                      ...
                      <input
                        ...
                        className={
                          styles.delBackground + "input-group border-0 mt-1"
                        }
                        disabled
                      />
